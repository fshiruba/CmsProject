define([
    ...
    "/ClientResources/Scripts/rgbaColorPicker.js",
],
    ...
    function (
        ...
        return declare("shiruba/ColorPicker", [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin, _CssStateMixin, _ValueRequiredMixin],
            {
                templateString:
